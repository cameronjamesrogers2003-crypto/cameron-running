...
export default function DashboardSkeleton() {
  return (
    <div className="space-y-4 pt-2 pb-24 lg:pb-8">
      <div className="rounded-2xl border border-white/[0.08] bg-[var(--card-bg)] p-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="rounded-2xl border border-white/[0.08] bg-[var(--card-bg)] p-4">
      ...
      <div className="rounded-2xl border border-white/[0.08] bg-[var(--card-bg)] p-4">
